...
Activation requires the merchant's API username, API password, payment-solution code, confirmed API version, sandbox acceptance and a controlled production test. Payment state is stored in D1; no KV namespace is required. Follow `reduniq-worker/DEPLOYMENT.md`.
